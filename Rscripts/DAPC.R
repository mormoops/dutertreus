...
setwd("/Users/Pedro/Desktop/Eptesicus_fuscus/CHAPTER.1/phylogenetics/DAPC")

#Upload dataset
Lgetu.VCF <- read.vcfR("your_filtered_snps.recode.vcf")
Lgetu.VCF
        # note: vcf files do not contain population information

# Load population data
pop.data <- read.table("/Users/Pedro/Desktop/Eptesicus_fuscus/CHAPTER.1/phylogenetics/DAPC/for_dapc_new_copy.txt", sep = "\t", header = T)
